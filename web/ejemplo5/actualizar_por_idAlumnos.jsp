            ...
            <form action="" method="post">
                ...
                <%
                    ...
                    if ("Search".equals(request.getParameter("btnSearch")) && id != null && !id.isEmpty()) {
                        ...
                        if (result != null) {
                            ...
                            edad = result.getInteger("edad") + "" != null ? result.get("edad").toString() : "No disponible";
                            estatura = result.getDouble("estatura") + "" != null ? result.get("estatura").toString() : "No disponible";
                            showResults = true;
                        }
                    }

                    if (request.getParameter("cmdBorrar") != null) {
                        String idAlumno = request.getParameter("txtId");
                        alumno.deleteOne(Filters.eq("idAlumno", idAlumno));
                        out.println("OK: ELIMINADO");
                    }

                    if (request.getParameter("cmdActualizar") != null) {
                        String idAlumno = request.getParameter("txtId");
                        nombre = request.getParameter("txtName");
                        edad = request.getParameter("txtAge");
                        estatura = request.getParameter("txtEstatura");

                        alumno.updateOne(
                                Filters.eq("idAlumno", idAlumno),
                                Updates.combine(
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="txtName" value="<%= nombre%>" /></td>
                    </tr>
                    <% } %>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="txtAge" value="<%= edad%>" /></td>
                    </tr>
                    <% } %>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="txtEstatura" value="<%= estatura%>" /></td>
                    </tr>
                    <% } %>
                </table>

                <input type="submit" value="BORRAR" name="cmdBorrar" />
                <input type="submit" value="ACTUALIZAR" name="cmdActualizar" />
